...
class TestEvent(unittest.TestCase):
	def setUp(self):
		...
		self.test_user = "test1@ektai.mail"
	...
	def test_assign(self):
		...
		self.assertEqual(ev._assign, json.dumps(["test@ektai.mail"]))
		...
		self.assertEqual(set(json.loads(ev._assign)), set(["test@ektai.mail", self.test_user]))
