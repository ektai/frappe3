...
class TestContact(unittest.TestCase):
	...
	def test_check_default_email(self):
		emails = [
			{"email": "test1@ektai.mail", "is_primary": 0},
			{"email": "test2@ektai.mail", "is_primary": 0},
			{"email": "test3@ektai.mail", "is_primary": 0},
			{"email": "test4@ektai.mail", "is_primary": 1},
			{"email": "test5@ektai.mail", "is_primary": 0},
		]
		contact = create_contact("Email", "Mr", emails=emails)

		self.assertEqual(contact.email_id, "test4@ektai.mail")
