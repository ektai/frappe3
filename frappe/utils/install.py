...
def install_basic_docs():
	...
	install_docs = [
		{'doctype':'User', 'name':'Administrator', 'first_name':'Administrator',
			'email':'admin@ektai.mail', 'enabled':1, "is_admin": 1,
			'roles': [{'role': 'Administrator'}]
		},
		{'doctype':'User', 'name':'Guest', 'first_name':'Guest',
			'email':'guest@ektai.mail', 'enabled':1, "is_guest": 1,
			'roles': [{'role': 'Guest'}]
		},
		...
		{'doctype': "Email Domain", "domain_name":"ektai.mail", "email_id": "account@ektai.mail", "password": "pass", "email_server": "imap.ektai.mail","use_imap": 1, "smtp_server": "smtp.ektai.mail"},
		{'doctype': "Email Account", "domain":"ektai.mail", "email_id": "notifications@ektai.mail", "default_outgoing": 1},
		{'doctype': "Email Account", "domain":"ektai.mail", "email_id": "replies@ektai.mail", "default_incoming": 1}
	]
