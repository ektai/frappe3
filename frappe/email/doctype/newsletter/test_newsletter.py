...
emails = ["test_subscriber1@ektai.mail", "test_subscriber2@ektai.mail",
			"test_subscriber3@ektai.mail", "test1@ektai.mail"]
...
class TestNewsletter(unittest.TestCase):
	...
	def send_newsletter(published=0):
		...
		newsletter = frappe.get_doc({
			...
			"send_from": "Test Sender <test_sender@ektai.mail>",
