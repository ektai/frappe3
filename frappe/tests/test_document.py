...
class TestDocument(unittest.TestCase):
	...
	def test_mandatory(self):
		...
		frappe.delete_doc_if_exists("User", "test_mandatory@ektai.mail", 1)

		d = frappe.get_doc({
			"doctype": "User",
			"email": "test_mandatory@ektai.mail",
		})
	...
	def test_link_validation(self):
		frappe.delete_doc_if_exists("User", "test_link_validation@ektai.mail", 1)

		d = frappe.get_doc({
			"doctype": "User",
			"email": "test_link_validation@ektai.mail",
	...
	def test_link_count(self):
		...
		doctype, name = 'User', 'test@ektai.mail'
